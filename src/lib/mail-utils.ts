...
export function getAddress(user: AT.LingdocsUser): Address {
  // TODO: Guard against ""
...
export async function sendAccountUpgradeMessage(user: AT.LingdocsUser) {
...
export async function sendUpgradeRequestToAdmin(
  userWantingToUpgrade: AT.LingdocsUser,
) {

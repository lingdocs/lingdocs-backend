...
export default {
  ...
  lingdocsServiceAccountKey: values[12].value,
  lingdocsServiceAccountEmail: values[13].value,
  lingdocsDictionarySpreadsheet: values[14].value,
  lingdocsDictionarySheetId: values[15].value,
};
